...
class VideoMAEEvaluator:
    def __init__(self, model_path="./video_mae_finetuned/checkpoint-38588", batch_size=4):
        """
        Args:
...
if __name__ == "__main__":
    ...
    evaluator = VideoMAEEvaluator(model_path="./video_mae_finetuned/checkpoint-38588", batch_size=8)
    evaluator.evaluate()